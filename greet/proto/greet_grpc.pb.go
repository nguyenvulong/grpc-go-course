...
type GreetServiceClient interface {
	...
	GreatManyTimes(ctx context.Context, in *GreetRequest, opts ...grpc.CallOption) (GreetService_GreatManyTimesClient, error)
...
func (c *greetServiceClient) GreatManyTimes(ctx context.Context, in *GreetRequest, opts ...grpc.CallOption) (GreetService_GreatManyTimesClient, error) {
	stream, err := c.cc.NewStream(ctx, &GreetService_ServiceDesc.Streams[0], "/greet.GreetService/GreatManyTimes", opts...)
	if err != nil {
		return nil, err
	}
...
func (x *greetServiceGreatManyTimesClient) Recv() (*GreetResponse, error) {
	m := new(GreetResponse)
...
type GreetServiceServer interface {
	...
	GreatManyTimes(*GreetRequest, GreetService_GreatManyTimesServer) error
...
func (UnimplementedGreetServiceServer) GreatManyTimes(*GreetRequest, GreetService_GreatManyTimesServer) error {
...
func (x *greetServiceGreatManyTimesServer) Send(m *GreetResponse) error {
